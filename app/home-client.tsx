      ...
      <div className="mx-auto flex w-full max-w-[81rem] flex-col gap-9">
        <header className="max-w-4xl space-y-2">
          <h1 className="text-lg font-semibold tracking-tight text-neutral-100 sm:text-2xl">
            AWS 자격증 문제·퀴즈 — AWS Quiz KR
          </h1>
          <p className="text-sm leading-relaxed text-neutral-400">
            한국어 객관식 문제집으로 AWS 자격증 시험 준비와 연습을 돕습니다. 문제 풀이·채점·정답률·풀이 완료까지 한
            화면에서 이용할 수 있습니다. AWS 문제, SAA 퀴즈, 클라우드 자격증 모의고사 느낌의 연습을 찾는 분께
            맞춰 두었습니다.
          </p>
        </header>

        <section className="rounded-md border border-neutral-700 bg-neutral-950/70 px-4 py-3">
          <h2 className="text-sm font-semibold text-neutral-100">
            AWS 덤프가 아닌 학습용 연습 문제
          </h2>
          <p className="mt-1 text-xs leading-relaxed text-neutral-400">
            AWS Quiz KR은 실제 시험 덤프나 유출 문제를 제공하지 않습니다. AWS 공식 시험 가이드와 공개 문서 범위를
            바탕으로 개념 이해와 복습을 돕는 한국어 연습 문제·퀴즈를 제공합니다.
          </p>
        </section>
